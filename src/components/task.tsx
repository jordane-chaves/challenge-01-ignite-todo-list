...
import { useTasks, Task as TaskType } from "../contexts/tasks";
...
export function Task({ task }: TaskProps) {
  const { deleteTask, toggleCompleteTask } = useTasks();
  ...
  return (
    <div className={styles.task}>
      <Checkbox checked={task.completed} onClick={handleToggleCompleteTask} />

      <span data-checked={task.completed}>{task.content}</span>
